export default {
  ...
  welcome_public: 'Chào mừng bạn đến với {{title}}!',
  ...
  info_password_reset_email_sent: 'Một email đã được gửi đến {{email}}, hãy kiểm tra hộp thư đến của bạn để tìm liên kết đặt lại mật khẩu của bạn',
  ...
  button_invite_friends: 'Mời bạn bè của bạn tham gia {{title}}!',
  ...
  info_invite_friends_header: 'Mời bạn bè của bạn tham gia {{title}}!',
  ...
  info_invite_friends_disabled_no_email: 'Tính năng "mời bạn bè" bị tắt do email chưa được định cấu hình trên {{title}}',
  info_invite_friends_enabled_no_email: 'Tính năng "mời bạn bè" được bật nhưng email chưa được định cấu hình trên {{title}} nên không thể sử dụng được',
  info_invitation_success_results: 'Lời mời của bạn đã được gửi thành công đến bạn bè của {{successCount}}',
  ...
  error_field_required: '{{ lĩnh vực được yêu cầu',
  ...
  error_field_notFound: 'Không thể định vị được {{field}}',
  ...
  error_field_raw_hex: '{{field}} không phải là một số thập lục phân (không cho phép 0x đứng đầu)',
  ...
  label_date_day_short_1: 'Của tôi',
  ...
  admin_label_publicConfig_locales: 'địa phương',
  ...
  admin_label_privateConfig_admin_user_locale: 'Địa phương',
  ...
  admin_label_total_user_count: 'Tổng số {{totalUserCount}} người dùng',
  ...
  admin_label_confirm_source_delete: 'Vui lòng xác nhận việc xóa nguồn: {{source}}',
  ...
  admin_label_self_source: 'bộ nhớ {{title}}',
