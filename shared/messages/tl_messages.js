export default {
  ...
  button_invite_friends: 'Anyayahan ang iyong mga kaibigan sa {{ pamagat }}!',
  ...
  info_invite_friends_header: 'Anyayahan ang iyong mga kaibigan sa {{ pamagat }}!',
  ...
  info_invite_friends_disabled_no_email: 'Ang tampok na "mag-imbita ng mga kaibigan" ay hindi pinagana dahil ang email ay hindi pa na-configure sa {{ pamagat }}',
  info_invite_friends_enabled_no_email: 'Ang tampok na "mag-imbita ng mga kaibigan" ay pinagana ngunit ang email ay hindi pa na-configure sa {{ pamagat }}, kaya hindi ito magagamit',
  info_invitation_success_results: 'Ang iyong imbitasyon ay matagumpay na naipadala sa {{ successCount }} mga kaibigan',
  info_invitation_error_results: 'Ang iyong imbitasyon ay hindi maihatid sa {{ errorCount }} mga kaibigan',
  ...
  error_field_min: 'Ang {{ field }} ay masyadong maikli',
  error_field_max: 'Ang {{ field }} ay masyadong mahaba',
  error_field_min_value: '{{ field }} ay masyadong maliit',
  error_field_max_value: 'Ang {{ field }} ay masyadong malaki',
  error_field_email: 'Ang {{ field }} ay hindi wastong email address',
  error_field_cannotDeleteSelf: 'Hindi mo matatanggal ang iyong sarili',
  error_field_alreadyExists: 'Umiiral na ang {{ thing }} na may {{ field.toLowerCase() }}.',
  error_field_readOnly: 'Ang {{ field }} ay read-only',
  error_field_accountNotFound: 'Hindi nahanap ang account o mali ang password',
  error_field_alreadyRegistered: 'Umiiral na ang isang account na may ganitong {{ field.toLowerCase() }}.',
  error_field_registrationNotAllowed: 'Hindi pinagana ng operator ng site ang paggawa ng account',
  error_field_url: 'Ang {{ field }} ay hindi wastong URL',
  error_field_host: 'Ang {{ field }} ay hindi wastong hostname',
  error_field_locale: 'Ang {{ field }} ay hindi wastong lokal',
  error_field_source: 'Ang {{ field }} ay hindi isang source name. Gumamit lamang ng mga titik, numero, at mga espesyal na character na ito: tuldok (.), gitling (-) at salungguhit (_)',
  error_field_notFound: 'Hindi mahanap ang {{ field }}',
  error_field_path: 'Ang {{ field }} ay hindi wastong landas',
  ...
  error_field_hex: 'Ang {{ field }} ay hindi isang hexadecimal na numero',
  error_field_username: 'Ang {{ field }} ay hindi wastong username. Dapat magsimula sa isang titik at naglalaman lamang ng mga titik, numero, underscore (_), gitling (-) at tuldok (.)',
  locale_en: 'Ingles',
  locale_es: 'Espanyol',
  locale_it: 'Italyano',
  locale_fr: 'Pranses',
  ...
  label_date_day_short_1: 'Aking',
  label_date_day_short_2: 'Tue',
  label_date_day_short_3: 'ikasal',
  label_date_day_short_4: 'Mangolekta',
  ...
  admin_title_site_administration: '{{ pamagat }} Pangangasiwa',
  ...
  admin_label_total_user_count: '{{ totalUserCount }} kabuuang mga user',
  admin_button_delete_user: 'Tanggalin ang User',
  admin_label_confirm_user_delete: 'Pakikumpirma ang pagtanggal ng user: {{ email }}',
