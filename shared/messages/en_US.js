export default {
  ...
  admin_label_title: 'Site Title',
  admin_label_siteUrl: 'Site URL',
  admin_label_public: 'Public?',
  admin_label_allowRegistration: 'Allow Registration?',
  admin_label_limitRegistration: 'Limit Registration',
  admin_label_locales: 'Locales',
  admin_label_defaultLocale: 'Default Locale',
  admin_label_emailEnabled: 'Email Enabled?',
  admin_label_timeout: 'Timeouts',
  admin_label_timeout_verify: 'Account Verification Token Timeout',
  admin_label_timeout_resetPassword: 'Reset Password Token Timeout',
  admin_label_admin: 'Administrator Settings',
  admin_label_admin_user: 'Admin User',
  admin_label_admin_user_email: 'Email',
  admin_label_admin_user_password: 'Password',
  admin_label_admin_user_firstName: 'First Name',
  admin_label_admin_user_lastName: 'Last Name',
  admin_label_admin_user_locale: 'Locale',
  admin_label_admin_overwrite: 'Overwrite?',
  admin_label_email: 'SMTP Settings',
  admin_label_email_host: 'Host',
  admin_label_email_port: 'Port',
  admin_label_email_user: 'Username',
  admin_label_email_password: 'Password',
  admin_label_email_secure: 'Secure?',
  admin_label_email_fromEmail: 'System email address',
  admin_label_redis: 'Redis Settings',
  admin_label_redis_host: 'Host',
  admin_label_redis_port: 'Port',
  admin_label_redis_flushAtStartup: 'Flush at startup?',
  admin_label_redis_listingCacheExpiration: 'Listing cache expiration',
  admin_label_redis_manifestCacheExpiration: 'Manifest cache expiration',
  admin_label_media: 'Media Support',
  admin_label_media_video: 'Video',
  admin_label_media_video_allowedCommands: 'Allowed commands',
  admin_label_encryption: 'Encryption Settings',
  admin_label_encryption_key: 'Encryption Key',
  admin_label_encryption_iv: 'Initialization Vector (IV)',
  admin_label_encryption_algo: 'Algorithm',
  admin_label_encryption_bcryptRounds: 'Bcrypt rounds',
  admin_label_session: 'Session Settings',
  admin_label_session_expiration: 'Session timeout',
  admin_label_autoscan: 'Autoscan Settings',
  admin_label_autoscan_enabled: 'Enable autoscan',
  admin_label_autoscan_interval: 'Regular scan interval',
  admin_label_autoscan_initialDelay: 'Startup scan delay',
  admin_label_autoscan_showTransformOutput: 'Log transform output',
  admin_label_autoscan_concurrency: 'Concurrency',
