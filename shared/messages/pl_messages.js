export default {
  ...
  info_invite_friends_disabled_no_email: 'Funkcja „zaproś znajomych” jest wyłączona, ponieważ adres e-mail nie został skonfigurowany w {{ title }}',
  info_invite_friends_enabled_no_email: 'Funkcja „zaproś znajomych” jest włączona, ale adres e-mail nie został skonfigurowany w {{ title }}, więc nie można z niego korzystać',
  ...
  button_back_to: 'Powrót do {{ prefiks }}',
  ...
  error_field_invalid: '{{pole }} jest nieprawidłowe',
  error_field_regex: '{{pole }} jest nieprawidłowe',
  error_field_min: '{{pole }} jest za krótkie',
  error_field_max: '{{pole }} jest za długie',
  error_field_min_value: '{{pole }} jest za małe',
  error_field_max_value: '{{pole }} jest za duże',
  error_field_email: '{{pole }} nie jest prawidłowym adresem e-mail',
  error_field_cannotDeleteSelf: 'Nie możesz usunąć siebie',
  error_field_alreadyExists: '{{ rzecz }} z {{ field.toLowerCase() }} już istnieje',
  error_field_readOnly: '{{pole }} jest tylko do odczytu',
  ...
  error_field_url: '{{pole }} nie jest prawidłowym adresem URL',
  error_field_host: '{{pole }} nie jest prawidłową nazwą hosta',
  error_field_locale: '{{pole }} nie jest prawidłowym językiem',
  error_field_source: '{{ pole }} nie jest nazwą źródła. Używaj tylko liter, cyfr i tych znaków specjalnych: kropki (.), łącznika (-) i podkreślenia (_)',
  error_field_notFound: 'Nie można zlokalizować {{ pola }}',
  error_field_path: '{{ pole }} nie jest prawidłową ścieżką',
  error_field_cannotMirrorToSame: 'Źródło odczytu i źródło zapisu nie mogą być tym samym źródłem',
  error_field_raw_hex: '{{pole }} nie jest liczbą szesnastkową (niedozwolone początkowe 0x)',
  error_field_hex: '{{pole }} nie jest liczbą szesnastkową',
  error_field_username: '{{ pole }} nie jest prawidłową nazwą użytkownika. Musi zaczynać się od litery i zawierać tylko litery, cyfry, podkreślenia (_), łączniki (-) i kropki (.)',
  ...
  locale_zh: 'chiński',
  label_date: '{{MMM}} {{d}}, {{RRRR}}',
  label_date_short: '{{M}}/{{d}}/{{RRRR}}',
  label_date_and_time: '{{MMM}} {{d}}, {{RRRR}} / {{h}}:{{m}}{{a}}',
  label_date_and_time_short: '{{M}}/{{d}}/{{RRRR}} {{h}}:{{m}}{{a}}',
  ...
  admin_label_publicConfig_locales: 'lokalny',
  ...
  admin_label_privateConfig_admin_user_locale: 'Lokalny',
  ...
  admin_label_self_source: 'Przechowywanie {{ title}}',
