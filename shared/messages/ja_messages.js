export default {
  ...
  error_field_source: '{{ field }} はソース名ではありません。文字、数字、および次の特殊文字のみを使用してください: ピリオド (.)、ハイフン (-)、アンダースコア (_)',
  ...
  admin_title_source_administration: 'ソース管理',
  ...
  admin_button_add_source: 'ソースを追加',
  admin_title_add_source: 'ソースを追加',
  admin_button_delete_source: 'ソースを削除',
  admin_button_scan_source: 'スキャン',
  admin_info_scan_scanning: '走査...',
  admin_info_scan_successful: 'スキャンが正常に開始されました',
  admin_info_scan_error: 'スキャン中にエラーが発生しました',
  admin_label_confirm_source_delete: 'ソースの削除を確認してください: {{ source }}',
  admin_info_source_added: '新しいソース \'{{ source }}\' が正常に追加されました',
  admin_info_source_add_error: 'ソース \'{{ source }}\' の追加中にエラーが発生しました',
  admin_label_source_name: 'ソース名',
  admin_label_self_source: '{{ title }} ストレージ',
  admin_label_source_type: 'ソースの種類',
  admin_label_source_readOnly: '読み取り専用？',
  admin_label_source_cacheSize: 'キャッシュ サイズの一覧表示 (無効にする場合はゼロ)',
  admin_label_source_encryption_enable: '暗号化を有効にする',
  admin_label_source_encryption_key: '暗号化キー',
  ...
  label_sourceType_s3_field_secret: 'AWS シークレット キー',
  label_sourceType_s3_field_bucket: 'S3 バケット',
  label_sourceType_s3_field_region: 'AWS リージョン',
  label_sourceType_s3_field_prefix: 'バケットのプレフィックス',
  label_sourceType_s3_field_delimiter: 'デリミタ',
  label_sourceType_b2: 'バックブレイズB2',
  label_sourceType_b2_field_key: 'キー ID',
  label_sourceType_b2_field_secret: 'アプリケーションキー',
  label_sourceType_b2_field_bucket: 'B2 バケット ID (名前ではない)',
  label_sourceType_b2_field_partSize: 'パーツサイズ',
  label_sourceType_b2_field_prefix: 'バケットのプレフィックス',
  label_sourceType_b2_field_delimiter: 'デリミタ',
  ...
  admin_label_migration_readSource: 'データの移行元のソース',
  admin_label_migration_readPath: 'パスから読み取る (ファイルシステムのルートは空白)',
  admin_label_readSource: 'ソースを読む',
  admin_label_readPath: '読み取りパス',
  admin_label_migration_writeSource: 'データを書き込むソース',
  admin_label_migration_writePath: 'パスへの書き込み (ファイルシステムのルートは空白)',
  admin_label_writeSource: '書き込みソース',
  ...
  admin_button_reindex_source: '再インデックス',
  ...
  admin_title_source_browser: 'ソースを参照',
  admin_title_reindex_status: 'インデックス作成ステータス',
  admin_button_browse_source: 'ブラウズ',
