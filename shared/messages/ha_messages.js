export default {
  ...
  error_field_source: '{{ field }} ba sunan tushe ba ne. Yi amfani da haruffa kawai, lambobi, da waɗannan haruffa na musamman: lokaci (.), saƙa (-) da ƙaranci (_)',
  ...
  admin_title_source_administration: 'Gudanarwar Madogararsa',
  ...
  admin_button_add_source: 'Ƙara Source',
  admin_title_add_source: 'Ƙara Source',
  admin_button_delete_source: 'Share Source',
  admin_button_scan_source: 'Duba',
  ...
  admin_label_confirm_source_delete: 'Da fatan za a tabbatar da goge tushen: {{ source }}',
  admin_info_source_added: 'An yi nasarar ƙara sabuwar tushen &#39; {{ source }} &#39;',
  admin_info_source_add_error: 'An sami kuskure wajen ƙara tushen&#39; {{ source }} &#39;',
  admin_label_source_name: 'Tushen Sunan',
  admin_label_self_source: '{{ title }} ajiya',
  admin_label_source_type: 'Nau&#39;in Tushen',
  admin_label_source_readOnly: 'Karanta-kawai?',
  admin_label_source_cacheSize: 'Girman cache jeri (sifili don kashewa)',
  admin_label_source_encryption_enable: 'Kunna boye-boye',
  admin_label_source_encryption_key: 'Maɓallin ɓoyewa',
  ...
  label_sourceType_s3_field_secret: 'Maɓallin Sirrin AWS',
  label_sourceType_s3_field_bucket: 'S3 Bukata',
  label_sourceType_s3_field_region: 'Yankin AWS',
  label_sourceType_s3_field_prefix: 'Prefix na guga',
  label_sourceType_s3_field_delimiter: 'Mai iyaka',
  label_sourceType_b2: 'Bayanan Bayani na B2',
  label_sourceType_b2_field_key: 'Mabuɗin ID',
  label_sourceType_b2_field_secret: 'Maɓallin Aikace-aikace',
  label_sourceType_b2_field_bucket: 'B2 Bucket ID (ba suna)',
  label_sourceType_b2_field_partSize: 'Girman sashi',
  label_sourceType_b2_field_prefix: 'Prefix na guga',
  label_sourceType_b2_field_delimiter: 'Mai iyaka',
  ...
  admin_label_migration_readSource: 'Tushen don ƙaura bayanai daga',
  admin_label_migration_readPath: 'Karanta daga hanya (blank don tushen tsarin fayil)',
  admin_label_readSource: 'Karanta tushe',
  admin_label_readPath: 'Karanta hanya',
  admin_label_migration_writeSource: 'Tushen rubuta bayanai a ciki',
  admin_label_migration_writePath: 'Rubuta zuwa hanya (blank don tushen tsarin fayil)',
  admin_label_writeSource: 'Rubuta tushen',
  ...
  admin_title_source_browser: 'Binciko Sources',
  admin_title_reindex_status: 'Matsayin Fihirisa',
  admin_button_browse_source: 'lilo',
