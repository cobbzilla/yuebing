export default {
  ...
  admin_label_library_source: 'Source Volume',
  admin_label_library_destination: 'Destination Volume',
  ...
  admin_label_confirm_volume_delete: 'Please confirm deletion of the data volume: {{ volume }}',
  admin_info_volume_added: 'The new data volume \'{{ volume }}\' was successfully added',
  admin_info_volume_deleted: 'The new data volume \'{{ volume }}\' was successfully removed',
  admin_info_volume_add_error: 'An error occurred adding data volume \'{{ volume }}\'',
  admin_label_volume_name: 'Data Volume Name',
  admin_label_self_volume: '{{ title }} storage',
  admin_label_volume_type: 'Data Volume Type',
  admin_label_volume_readOnly: 'Read-only?',
  admin_label_volume_readOnly_hint: 'Check this box to create a source volume. To create a destination volume, leave it unchecked',
  admin_label_volume_cacheSize: 'Listing cache size (zero to disable)',
  admin_label_volume_encryption_enable: 'Enable encryption',
