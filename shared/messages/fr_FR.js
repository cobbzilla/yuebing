export default {
  ...
  admin_label_title: 'Titre du site',
  admin_label_siteUrl: 'URL du site',
  admin_label_public: 'Est-ce public?',
  admin_label_allowRegistration: 'Autoriser l\'inscription?',
  admin_label_limitRegistration: 'Limiter l\'inscription?',
  admin_label_locales: 'Localités',
  admin_label_defaultLocale: 'Localité standard',
  admin_label_emailEnabled: 'Le courrier électronique est-il activé?',
  admin_label_timeout: 'Délais d\'expiration',
  admin_label_verify: 'Tempsage de jeton de vérification du compte',
  admin_label_resetPassword: 'Réinitialiser le temps mort de jeton de mot de passe',
  admin_label_admin: 'Paramètres d\'administrateur',
  admin_label_admin_user: 'Utilisateur d\'administrateur',
  admin_label_admin_user_email: 'E-mail',
  admin_label_admin_user_password: 'Mot de passe',
  admin_label_admin_user_firstName: 'Prénom',
  admin_label_admin_user_lastName: 'Nom',
  admin_label_admin_user_locale: 'Localité',
  admin_label_admin_overwrite: 'Écraser?',
  admin_label_email: 'Paramètres SMTP',
  admin_label_email_host: 'Hôte',
  admin_label_email_port: 'Port',
  admin_label_email_user: 'Nom d\'utilisateur',
  admin_label_email_password: 'Mot de passe',
  admin_label_email_secure: 'Sécurisé?',
  admin_label_email_fromEmail: 'Adresse e-mail de l\'expéditeur du système',
  admin_label_redis: 'Paramètres redis',
  admin_label_redis_host: 'Hôte',
  admin_label_redis_port: 'Port',
  admin_label_redis_flushAtStartup: 'Vider le cache à l\'heure de début?',
  admin_label_redis_listingCacheExpiration: 'Lister l\'expiration du cache',
  admin_label_redis_manifestCacheExpiration: 'Expiration de cache manifeste',
  admin_label_media: 'Support multimédia',
  admin_label_media_video: 'Vidéo',
  admin_label_media_video_allowedCommands: 'Commandes autorisées',
  admin_label_encryption: 'Paramètres de chiffrement',
  admin_label_encryption_key: 'Clé de cryptage',
  admin_label_encryption_iv: 'Vecteur d\'initialisation (VI)',
  admin_label_encryption_algo: 'Algorithme',
  admin_label_encryption_bcryptRounds: 'Balles de bcrypt',
  admin_label_session: 'Paramètres de session',
  admin_label_session_expiration: 'Expiration de la session',
  admin_label_autoscan: 'Paramètres de numérisation automatique',
  admin_label_autoscan_enabled: 'Activer la numérisation automatique?',
  admin_label_autoscan_interval: 'Intervalle de balayage régulier',
  admin_label_autoscan_initialDelay: 'Délai de balayage de démarrage',
  admin_label_autoscan_showTransformOutput: 'Sortie de transformation du journal',
  admin_label_autoscan_concurrency: 'Concurrence',
