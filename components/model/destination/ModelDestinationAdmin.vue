      ...
      <v-row v-if="addingObject">
        <v-col>
          <OrmForm
            ...
            :label-prefixes="['admin_label_destination_', 'label_']"
              ...
              <v-col>
                <table v-if="destinationList && destinationList.length > 0">
                  ...
                  <tr v-for="(obj, objIndex) in destinationList" :key="objIndex">
                    ...
                    <td>
                      <v-btn v-if="canEdit(obj)" :disabled="destinationStore.destinationBusy" @click.stop="showEditOrm(obj)">
                        <Icon name="material-symbols:edit" />
                      </v-btn>
                    </td>
                    <td>
                      <v-btn v-if="canDelete(obj)" :disabled="destinationStore.destinationBusy" @click.stop="delObject(obj)">
...
<script setup lang="ts">
  ...
  watch(destinationList, (newList, _oldList) => {
