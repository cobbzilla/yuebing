...
export default {
  ...
  computed: {
    ...
    isReady () {
      return this.isBasicallyReady && this.hasSources
    },
    hasAssets () {
      return this.object && typeof this.object.meta === 'object' && typeof this.object.meta.assets === 'object' && Object.keys(this.object.meta.assets).length > 0
    }//,
    // availableSizes () {
    //   const sizes = {}
    //   if (this.isReady) {
  ...
  methods: {
    ...
    refreshMeta () {
      ...
      if (this.isReady && this.hasAssets && !this.hasSources) {
