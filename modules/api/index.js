...
module.exports = async function (moduleOptions) {
  ...
  if (this.options.dev || this.options._start) {
    ...
    this.addServerMiddleware('~/serverMiddleware/api/user/tags')
    ...
    this.addServerMiddleware('~/serverMiddleware/api/admin/volumes')
    this.addServerMiddleware('~/serverMiddleware/api/admin/libraries')
    ...
    this.addServerMiddleware('~/serverMiddleware/api/admin/paths')
  }
}
