...
export default defineEventHandler(async (event: H3Event) => {
  return await filterErrors(event, "privateConfig.create", async (event: H3Event) => {
    return await requireAdminAccountObject(event, "privateConfig.create", async (event: H3Event, session, account) => {
